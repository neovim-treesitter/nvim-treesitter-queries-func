# nvim-treesitter-queries-func

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-func/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-func/actions/workflows/validate.yml)

Neovim tree-sitter queries for **func**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-func",
...
- [ ] Changes are scoped to `func` — do not include files for other languages
